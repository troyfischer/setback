...
TypeScript client for the FastAPI setback server in [`../python`](../python).
...
- The server must allow the client web origin in CORS, and its Google OAuth redirect URI must remain `${BASE_URL}/api/auth/google/callback`.
