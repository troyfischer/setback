  ...
  return (
    <div className="mx-auto flex w-full max-w-lg flex-col gap-8 px-5 py-16">
      ...
      <div className="flex flex-col gap-2">
        <span className="text-xs font-bold uppercase tracking-[2px] text-gold">Card Table</span>
        <h1 className="text-6xl font-black tracking-tight text-gray-900 dark:text-white leading-none">Setback</h1>
      ...
      <div className="rounded-3xl backdrop-blur-xl border shadow-xl p-7 flex flex-col gap-5 bg-white/[0.65] border-white/75 shadow-black/[0.04] dark:bg-white/[0.06] dark:border-white/[0.10] dark:shadow-black/50">
        <div>
          <h2 className="text-xl font-extrabold text-gray-900 dark:text-white">Sign in to play</h2>
